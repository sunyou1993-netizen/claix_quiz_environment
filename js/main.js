...
// ==========================================
// 1. DATA: 서울신답초등학교 환경보호 O/X 퀴즈 데이터 (160문제)
// ==========================================
const QUIZ_DATA = {
  schoolName: "",
  title: "환경보호 O/X 퀴즈",
  questions: [
    ...
    { id: 101, question: "꿀벌이 사라지면 많은 식물이 꽃가루받이(수분)를 하지 못해 식량 생산과 생태계에 큰 위기가 찾아온다.", answer: "O", explanation: "맞아요! 꿀벌은 전 세계 주요 농작물과 야생 꽃들의 번식을 돕는 매우 소중한 곤충입니다." },
    { id: 102, question: "거대한 고래는 살아있는 동안과 죽은 후에도 엄청난 양의 탄소를 바다 깊은 곳에 가두어 온난화를 늦춰준다.", answer: "O", explanation: "맞아요! 고래 한 마리는 수천 그루의 나무와 맞먹는 탄소를 몸에 저장하는 위대한 기후 지킴이입니다." },
    { id: 103, question: "스프링 공책을 버릴 때는 종이와 플라스틱 또는 쇠 스프링을 분리하지 않고 통째로 종이류에 버려야 한다.", answer: "X", explanation: "틀려요! 스프링을 꼭 분리해서 스프링은 철이나 일반 쓰레기로, 종이 본체만 종이류로 분리배출해야 합니다." },
    { id: 104, question: "다 쓴 칫솔은 플라스틱 손잡이와 칫솔모가 복합적으로 섞여 있어 플라스틱 재활용이 되지 않는 일반 쓰레기이다.", answer: "O", explanation: "맞아요! 칫솔은 다양한 재질이 결합되어 있어 재활용 선별이 어려우므로 일반 종량제 봉투에 버려야 합니다." },
    { id: 105, question: "알약이 하나씩 포장된 은박 플라스틱(PTP) 포장재는 복합 재질이므로 일반 쓰레기로 버려야 한다.", answer: "O", explanation: "맞아요! 비닐과 은박 호일이 붙어 있어 분리가 불가능하므로 일반 쓰레기로 배출해야 합니다." },
    { id: 106, question: "유리병을 버릴 때는 철이나 알루미늄으로 된 뚜껑을 꼭 닫은 채로 유리 분리수거함에 넣어야 한다.", answer: "X", explanation: "틀려요! 병뚜껑은 재질에 맞게 캔·고철류로 따로 분리하고, 유리병 본체만 비우고 헹궈서 배출해야 합니다." },
    { id: 107, question: "세탁기를 돌릴 때 찬물 코스로 세탁해도 물을 데우는 데 쓰이는 전기에너지를 80% 이상 절약할 수 있다.", answer: "O", explanation: "맞아요! 세탁 시 소비되는 전력의 대부분은 물을 데우는 데 쓰이므로 찬물 세탁이 온실가스 절감에 아주 좋습니다." },
    { id: 108, question: "CD, DVD, 비디오테이프는 플라스틱 분리수거함에 넣으면 100% 깔끔하게 재활용된다.", answer: "X", explanation: "틀려요! 여러 화학 물질과 필름이 섞여 재활용이 불가능하므로 종량제 봉투에 일반 쓰레기로 버려야 합니다." },
    { id: 109, question: "엘리베이터 대신 계단을 이용하면 건강도 챙기고 아파트와 건물의 전기 소비 및 탄소 배출을 줄일 수 있다.", answer: "O", explanation: "맞아요! 몇 개 층 정도는 계단을 오르내리면 전력 낭비를 줄이고 몸도 튼튼해지는 1석 2조의 행동입니다." },
    { id: 110, question: "손을 씻은 후 일회용 종이타월 대신 개인 손수건을 사용하면 소중한 나무와 폐기물을 크게 줄일 수 있다.", answer: "O", explanation: "맞아요! 매일 무심코 쓰는 종이타월을 줄이고 손수건을 쓰면 수많은 나무를 베지 않고 지킬 수 있습니다." },
    { id: 111, question: "매년 3월 22일은 물의 소중함과 전 세계 물 부족 문제의 심각성을 알리는 '세계 물의 날'이다.", answer: "O", explanation: "맞아요! 깨끗한 물의 가치를 되새기고 물을 아끼는 실천을 약속하는 유엔(UN) 공식 기념일입니다." },
    { id: 112, question: "기름과 치즈가 묻은 피자 상자의 바닥 부분은 종이 재활용이 잘되므로 종이류로 버려야 한다.", answer: "X", explanation: "틀려요! 기름때와 음식물이 밴 종이는 재활용 공정에서 녹지 않으므로 찢어서 일반 쓰레기로 버려야 합니다." },
    { id: 113, question: "스마트폰 화면 밝기를 조금 낮추거나 다크 모드를 사용하면 배터리 소모를 줄여 에너지를 절약할 수 있다.", answer: "O", explanation: "맞아요! 디스플레이 밝기를 조절하면 충전 횟수를 줄이고 디지털 에너지 소비를 감축할 수 있습니다." },
    { id: 114, question: "고무장갑이나 비닐 랩은 깨끗이 씻어서 비닐류나 고무 재활용함에 넣어야 한다.", answer: "X", explanation: "틀려요! 고무장갑과 얇은 랩은 재활용 대상 품목이 아니므로 일반 쓰레기(종량제 봉투)로 버려야 합니다." },
    { id: 115, question: "매년 9월 7일은 우리나라가 제안하여 유엔(UN) 공식 기념일로 채택된 '푸른 하늘의 날'이다.", answer: "O", explanation: "맞아요! 맑은 공기와 푸른 하늘을 지키기 위해 세계가 함께 대기오염을 줄이자는 소중한 날입니다." },
    { id: 116, question: "일주일에 하루 채식을 실천하는 '고기 없는 날'은 축산업에서 나오는 메탄가스와 온실가스를 줄이는 데 큰 도움이 된다.", answer: "O", explanation: "맞아요! 가축을 키우고 사료를 재배하는 데 막대한 탄소와 물이 들기 때문에 채식 한 끼도 지구에 큰 힘이 됩니다." },
    { id: 117, question: "내용물이 100% 물로 채워진 친환경 아이스팩은 물을 따라 버리고 비닐 포장재만 비닐류로 분리배출하면 된다.", answer: "O", explanation: "맞아요! 물을 가위로 잘라 하수구에 비우고 겉 비닐을 깨끗하게 배출하면 올바른 친환경 분리수거가 됩니다." },
    { id: 118, question: "흙 속에 사는 지렁이는 낙엽과 유기물을 분해하여 땅을 숨 쉬게 하고 비옥하게 가꾸어 주는 고마운 생물이다.", answer: "O", explanation: "맞아요! 지렁이는 토양을 기름지게 하고 생태계 순환을 돕는 '자연의 농부'입니다." },
    { id: 119, question: "숲에 나무를 많이 심으면 산사태를 막아주고 빗물을 머금어 홍수와 가뭄을 완화하는 '녹색 댐' 역할을 한다.", answer: "O", explanation: "맞아요! 튼튼한 나무뿌리가 흙을 붙잡고 스펀지처럼 물을 흡수하여 자연재해를 크게 막아줍니다." },
    { id: 120, question: "빨간 국물이 밴 컵라면 용기는 햇볕이 잘 드는 곳에 하루 정도 말리면 자국이 하얗게 지워져 깨끗하게 재활용된다.", answer: "O", explanation: "맞아요! 고추장의 붉은 캡사이신 색소는 자외선에 자연 분해되므로 깨끗이 씻어 햇볕에 말린 뒤 스티로폼으로 배출할 수 있습니다." },
    { id: 121, question: "옥수수로 만든 생분해 플라스틱(PLA)은 길거리나 흙바닥에 아무렇게나 버려도 며칠 만에 다 썩는다.", answer: "X", explanation: "틀려요! 생분해 플라스틱도 특정 고온(58도 이상)의 전문 퇴비화 시설에서만 분해되므로 함부로 버리면 안 됩니다." },
    { id: 122, question: "바닷가에 자라는 맹그로브 숲은 해일과 태풍을 막아주고 육지 숲보다 몇 배 많은 탄소를 저장한다.", answer: "O", explanation: "맞아요! 맹그로브는 해안선 침식을 막고 수많은 해양 생물의 안식처이자 뛰어난 탄소 흡수원입니다." },
    { id: 123, question: "빨래를 건조기에 돌리지 않고 햇볕과 바람에 자연 건조하면 전기에너지와 탄소 배출을 크게 줄일 수 있다.", answer: "O", explanation: "맞아요! 전력 소모가 큰 건조기 대신 자연 바람에 옷을 말리면 섬유도 덜 상하고 에너지도 절약됩니다." },
    { id: 124, question: "도자기로 만든 깨진 찻잔이나 화분은 플라스틱류 분리수거함에 버려야 한다.", answer: "X", explanation: "틀려요! 도자기는 흙을 구워 만든 불연성 물질로 재활용이 안 되므로 특수 규격 마대나 일반 쓰레기로 버려야 합니다." },
    { id: 125, question: "인쇄할 때 양면인쇄를 생활화하거나 이면지를 메모지로 쓰면 종이 소비를 절반으로 줄일 수 있다.", answer: "O", explanation: "맞아요! 종이의 양면을 알뜰하게 활용하면 학교와 사무실의 종이 쓰레기를 크게 줄입니다." },
    { id: 126, question: "매년 5월 31일은 바다의 소중함과 해양 자원 보전의 중요성을 알리는 '바다의 날'이다.", answer: "O", explanation: "맞아요! 바다 환경의 소중함을 기억하고 해양 오염을 막기 위한 실천을 독려하는 날입니다." },
    { id: 127, question: "양치를 할 때 물을 잠그지 않고 3분 동안 틀어두면 약 30리터 이상의 물이 낭비된다.", answer: "O", explanation: "맞아요! 양치 컵을 쓰면 0.5리터로 충분하므로 꼭 수도꼭지를 잠그는 습관을 가져야 합니다." },
    { id: 128, question: "백열전구나 형광등이 깨졌을 때는 일반 유리병 수거함에 넣어서 배출해야 한다.", answer: "X", explanation: "틀려요! 조명용 유리는 병유리와 성분이 달라 재활용되지 않으므로 신문지에 안전하게 싸서 종량제 봉투에 버려야 합니다." },
    { id: 129, question: "빗물 저장 탱크(저류조)를 설치하면 홍수를 예방하고 가뭄 때 화단 물주기와 청소용수로 쓸 수 있다.", answer: "O", explanation: "맞아요! 하늘에서 내리는 빗물을 똑똑하게 모아 재활용하는 친환경 수자원 활용법입니다." },
    { id: 130, question: "컴퓨터 화면 보호기(스크린세이버)를 켜두면 모니터가 완전히 꺼진 것처럼 전기를 전혀 쓰지 않는다.", answer: "X", explanation: "틀려요! 화면 보호기도 그래픽을 계속 작동시켜 전력을 쓰므로 자리를 비울 때는 모니터 전원을 꺼야 합니다." },
    { id: 131, question: "고무줄, 노끈, 풍선 등은 작고 얇아도 비닐류 분리수거함에 넣어서 배출해야 한다.", answer: "X", explanation: "틀려요! 고무나 복합 노끈은 비닐 재활용이 되지 않으므로 일반 종량제 쓰레기봉투에 버려야 합니다." },
    { id: 132, question: "종이 쇼핑백을 버릴 때는 겉에 붙은 천 끈이나 비닐 코팅, 쇠 고리를 분리해서 버려야 한다.", answer: "O", explanation: "맞아요! 손잡이 끈 등 이물질을 제거하고 순수 종이 본체만 펴서 배출해야 재활용됩니다." },
    { id: 133, question: "전기밥솥을 24시간 내내 보온 상태로 두는 것은 밥을 새로 짓는 것보다 전기를 훨씬 적게 먹는다.", answer: "X", explanation: "틀려요! 하루 종일 보온을 켜두면 많은 전력이 소모되므로 남은 밥은 소분 냉동 후 데워먹는 것이 훨씬 절약됩니다." },
    { id: 134, question: "식물 오이 열매를 말려 만든 천연 루파 수세미는 미세플라스틱을 만들지 않고 자연에서 생분해된다.", answer: "O", explanation: "맞아요! 천연 식물 섬유 수세미는 설거지할 때 찌꺼기가 나와도 자연으로 돌아가는 친환경 제품입니다." },
    { id: 135, question: "매년 9월 6일은 쓰레기를 줄이고 자원을 다시 순환하자는 의미를 담은 '자원순환의 날'이다.", answer: "O", explanation: "맞아요! '9'와 '6'은 서로 거꾸로 된 숫자로 자원이 끊임없이 순환한다는 뜻을 담고 있습니다." },
    { id: 136, question: "멸종위기 1급 천연기념물인 '수달'이 도시 하천에 나타난 것은 하천 생태계가 맑고 건강해졌다는 신호이다.", answer: "O", explanation: "맞아요! 깨끗한 물과 풍부한 먹이가 있는 곳에만 사는 수달의 귀환은 하천 복원의 기쁜 결실입니다." },
    { id: 137, question: "식물이 내뿜는 천연 물질인 '피톤치드'는 공기 중 해로운 세균을 줄이고 숲을 맑게 가꾸어 준다.", answer: "O", explanation: "맞아요! 나무들이 스스로를 보호하기 위해 내뿜는 피톤치드는 공기를 정화하고 사람의 건강도 돕습니다." },
    { id: 138, question: "여름철 차량 앞 유리에 햇빛 가리개를 씌워두면 실내 온도 상승을 막아 에어컨 사용을 줄일 수 있다.", answer: "O", explanation: "맞아요! 실내 온도 상승을 미리 막아 시동 후 에어컨을 강하게 틀지 않아도 되므로 기름을 아낍니다." },
    { id: 139, question: "유통기한이 지난 매니큐어나 화장품 액체를 세면대에 부어 물로 흘려보내면 안전하다.", answer: "X", explanation: "틀려요! 화장품 성분이 수질을 심각하게 오염시키므로 휴지나 키친타월에 흡수시켜 일반 쓰레기로 버려야 합니다." },
    { id: 140, question: "에너지 탄소중립포인트 제도는 전기·수도·가스를 절약한 가정에 상품권이나 마일리지를 주는 친환경 제도이다.", answer: "O", explanation: "맞아요! 에너지를 아낀 만큼 포인트 혜택도 받고 지구도 살리는 아주 유익한 제도입니다." },
    { id: 141, question: "문구용 커터칼날이나 부러진 가위는 신문지나 두꺼운 종이로 꼼꼼히 감싼 뒤 캔/고철류로 안전하게 버려야 한다.", answer: "O", explanation: "맞아요! 청소 노동자가 다치지 않도록 테이프로 감싸 안전하게 고철류로 배출해야 합니다." },
    { id: 142, question: "바다에 버려진 폐그물에 바다거북과 물고기가 걸려 계속해서 희생되는 현상을 '유령 어업'이라고 한다.", answer: "O", explanation: "맞아요! 버려진 나일론 그물은 썩지 않고 바닷속에서 끊임없이 해양 생물을 위협하므로 수거해야 합니다." },
    { id: 143, question: "겨울철 창문에 에어캡(뽁뽁이)이나 단열 필름을 붙이면 실내 온기가 빠져나가는 것을 막아 난방비를 아낄 수 있다.", answer: "O", explanation: "맞아요! 창문의 공기층이 찬바람을 막아주어 실내 온도를 2~3도 따뜻하게 유지해 줍니다." },
    { id: 144, question: "재활용 비닐봉투 속에는 크기가 작다는 이유로 담배꽁초나 껌을 함께 넣어 버려도 된다.", answer: "X", explanation: "틀려요! 담배꽁초와 껌은 다른 재활용품까지 오염시키므로 절대 섞지 말고 일반 쓰레기로 버려야 합니다." },
    { id: 145, question: "바닥 청소를 할 때 정전기 청소포나 물걸레를 이용하면 먼지가 공기 중에 날리지 않고 미세먼지도 잘 닦인다.", answer: "O", explanation: "맞아요! 진공청소기 뒤로 나오는 미세먼지를 줄이고 실내 공기를 쾌적하게 관리하는 좋은 청소법입니다." },
    { id: 146, question: "자동차 타이어가 주행 중 닳으면서 도로에 날리는 미세 고무 입자도 미세먼지와 미세플라스틱을 발생시킨다.", answer: "O", explanation: "맞아요! 타이어 마모 가루도 대기와 빗물을 통해 하천으로 흘러가 환경에 영향을 줍니다." },
    { id: 147, question: "일회용 나무젓가락 대신 내 쇠젓가락을 챙겨 다니면 버려지는 나무와 폐기물을 크게 줄일 수 있다.", answer: "O", explanation: "맞아요! 매년 수억 개씩 버려지는 나무젓가락을 아끼고 소중한 나무를 보호하는 훌륭한 실천입니다." },
    { id: 148, question: "다 쓴 건전지의 전극(양 끝)에 절연 테이프를 붙여 폐건전지 수거함에 넣으면 잔류 전력으로 인한 화재를 예방할 수 있다.", answer: "O", explanation: "맞아요! 여러 건전지가 닿아 생길 수 있는 스파크와 화재 위험을 막아주는 안전한 분리배출 방법입니다." },
    { id: 149, question: "카페에서 커피를 마실 때 컵 홀더(슬리브) 대신 다회용 텀블러나 천 홀더를 쓰면 종이 낭비를 줄인다.", answer: "O", explanation: "맞아요! 한 번 쓰고 버려지는 골판지 슬리브를 아끼면 자원을 크게 절약할 수 있습니다." },
    { id: 150, question: "식물을 키우다 남은 화분 흙은 일반 종이 쓰레기통에 함께 버려야 한다.", answer: "X", explanation: "틀려요! 흙은 종이가 아니므로 화단에 뿌려주거나 양이 많으면 불연성 전용 마대에 버려야 합니다." },
    { id: 151, question: "솜이 잔뜩 들어간 낡은 솜이불이나 베개는 의류수거함에 넣으면 100% 헌 옷으로 재활용된다.", answer: "X", explanation: "틀려요! 솜이불과 베개, 찢어진 인형은 의류수거함 배출 대상이 아니므로 대형폐기물이나 종량제 봉투에 버려야 합니다." },
    { id: 152, question: "세탁 세제를 권장량보다 2~3배 많이 넣으면 옷이 훨씬 깨끗해지고 물도 아낄 수 있다.", answer: "X", explanation: "틀려요! 세제를 많이 넣으면 세척력은 그대로이고 오히려 헹굼 물이 낭비되며 수질 오염을 일으킵니다." },
    { id: 153, question: "매년 4월 5일 '식목일'은 나무를 아끼고 심어 푸른 숲을 가꾸고 지구를 푸르게 만들자는 뜻깊은 날이다.", answer: "O", explanation: "맞아요! 한 그루의 나무가 자라 평생 동안 수많은 온실가스를 흡수하고 맑은 산소를 선물해 줍니다." },
    { id: 154, question: "학교 급식을 골고루 남김없이 다 먹으면 음식물 쓰레기를 줄이고 지구의 탄소 발자국을 줄일 수 있다.", answer: "O", explanation: "맞아요! 음식을 만들고 버리는 과정에서 생기는 메탄가스를 줄이는 가장 쉽고 멋진 식습관입니다." },
    { id: 155, question: "다 쓴 알루미늄 음료수 캔을 재활용하면 새 알루미늄을 원석에서 채굴해 만들 때보다 에너지를 95%나 절약한다.", answer: "O", explanation: "맞아요! 캔 분리수거는 엄청난 전기와 에너지를 절약하는 최고의 자원순환 방법입니다." },
    { id: 156, question: "전자레인지 내부를 청소할 때 물과 식초를 섞어 데운 뒤 닦아내면 화학 세제 없이 찌든 때를 쉽게 없앨 수 있다.", answer: "O", explanation: "맞아요! 천연 식초의 산성 성분이 기름때와 냄새를 잡아주어 환경에도 건강에도 좋습니다." },
    { id: 157, question: "밤에 켜두는 지나치게 밝은 인공조명이 야생동물과 식물의 생체 리듬을 깨뜨리는 것을 '빛공해'라고 한다.", answer: "O", explanation: "맞아요! 과도한 야간 조명은 철새의 이동을 방해하고 나무가 밤에 쉬지 못하게 해 생태계를 어지럽힙니다." },
    { id: 158, question: "바다에 떠다니는 거대한 '태평양 쓰레기 섬'의 플라스틱들은 사람의 눈에 보이지 않는 미세플라스틱으로 점점 부서진다.", answer: "O", explanation: "맞아요! 햇빛과 파도에 쪼개진 미세플라스틱은 바다 생물들의 몸속에 축적되어 큰 피해를 줍니다." },
    { id: 159, question: "냉장고 뒤쪽의 먼지를 주기적으로 청소해 주면 냉각 효율이 좋아져 전기를 덜 소모한다.", answer: "O", explanation: "맞아요! 방열판에 쌓인 먼지를 털어내면 열 방출이 잘 되어 전기 요금과 에너지를 아낄 수 있습니다." },
    { id: 160, question: "지구는 우리만의 것이 아니며, 자연과 함께 공존하고 미래 세대를 위해 깨끗하게 지켜야 할 소중한 별이다.", answer: "O", explanation: "맞아요! 우리가 오늘 실천하는 작은 환경 보호가 미래의 푸른 지구를 만드는 가장 큰 힘입니다! 🌍✨" }
  ]
};
